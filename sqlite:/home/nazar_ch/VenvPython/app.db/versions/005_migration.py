...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['user'].columns['address'].drop()
    post_meta.tables['user'].columns['telephone'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['user'].columns['address'].create()
    post_meta.tables['user'].columns['telephone'].drop()
